...
if selected == "Materi":
    ...
    st.write(":blue[RUMUS NORMALITAS]")
    st.write("N = bobot zat terlarut (mg) / (FP x V titran x BE)")
    ...
    st.write(":blue[RUMUS KADAR DENGAN FP]")
    st.write("% = (V titran x N titran x BE titrat x 10^-3 x FP x 100%) / V titrat (mL)")
    
    st.write(":blue[RUMUS KADAR DENGAN FP]")
    st.write("% = (V titran x N titran x BE titrat x 10^-3 x 100%) / V titrat (mL)")
    ...
    st.write(":blue[RUMUS KADAR Na2CO3]")
    st.write("% Na2CO3 = [(2(b-a)) x N HCl x BE Na2CO3 x 10^-3 x 100 %] / V contoh (mL)")
     
    st.write(":blue[RUMUS KADAR NaOH]")
    st.write("% NaOH = [(2a-b) x N HCl x BE NaOH x 10^-3 x 100 %] / V contoh (mL)")   
